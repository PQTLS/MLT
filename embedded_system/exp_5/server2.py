...
def run_commands(signature=''):
    commands = [
        ...
        'sudo ip netns exec server_namespace2 ../openssl-OQS-OpenSSL_1_1_1-stable/apps/openssl s_server -cert server.crt -key server.key -tls1_3'
...
if __name__ == "__main__":
    signature = "rsa:2048"  # Replace with the desired signature algorithm in README.md
