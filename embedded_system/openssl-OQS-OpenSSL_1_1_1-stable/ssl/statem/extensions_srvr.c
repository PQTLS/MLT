                                        ...
                                        size_t chainidx)
{
    ...
    if (do_pqc || do_hybrid) {
      ...
      if ((oqs_encodedPoint = (uint8_t *)aligned_alloc(32,oqs_kem->length_ciphertext)) == NULL ||
          (oqs_shared_secret = (uint8_t *)aligned_alloc(32,oqs_kem->length_shared_secret)) == NULL ||
