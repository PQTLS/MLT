...
#Ke_alg      =['kyber768']
#Ke_alg      = ['kyber512']
#Ke_alg      =['secp521r1','p521_kyber1024']
#Ke_alg      =['secp384r1','p384_kyber768']
#Ke_alg      = ['prime256v1','p256_kyber512']
...
folder_path = os.path.join("data/522emulation", current_time)
...
for i in range(3):
    ...
    # 在文件夹中创建测试数据文件
    file_name = os.path.join(folder_path, '{}_{}ms_p521_dilithium5_full.csv'.format(ke_alg, rtt_str))
